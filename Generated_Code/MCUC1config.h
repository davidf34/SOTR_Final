...
/* identification of CPU/core used. __CORTEX_M is defined in CMSIS-Core.
   Otherwise CPU Family is set automatically by Processor Expert: detected: HCS08 (supported: "Kinetis", "S32K", "HCS08")
*/
...
#define MCUC1_CONFIG_CPU_IS_ARM_CORTEX_M    (0 || MCUC1_CPU_IS_ARM_CORTEX_M)
  /*!< 1: ARM Cortex-M family, 0 otherwise */
#define MCUC1_CONFIG_CPU_IS_KINETIS         (0 && MCUC1_CONFIG_CPU_IS_ARM_CORTEX_M)
...
#define MCUC1_CONFIG_CPU_IS_HCS08           (1)
...
/* identification of Cortex-M core. __FPU_USED can be defined in CMSIS-Core */
  ...
  #define MCUC1_CONFIG_CORTEX_M      (-1)
